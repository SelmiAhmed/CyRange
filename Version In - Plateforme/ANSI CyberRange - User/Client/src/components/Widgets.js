...
import { faAngleDown,faEye, faAngleUp, faChartArea, faChartBar, faChartLine, faFlagUsa, faFolderOpen, faGlobeEurope, faPaperclip, faUserPlus } from '@fortawesome/free-solid-svg-icons';
import { faAngular, faBootstrap, faReact, faVuejs } from "@fortawesome/free-brands-svg-icons";
import { Col, Row, Card, Image,Form,Modal ,Button,InputGroup, ListGroup, ProgressBar } from '@themesberg/react-bootstrap';
...
<div>
    ...
    <Modal.Header>
      <Modal.Title className="h6">Update Info</Modal.Title>
    ...
    <Form.Control id="Username" as="input" name="Username"  onChange={formik.handleChange}
            value={formik.values.Username}  required placeholder="Username" />
  </Form.Group>
  <Form.Group>
    <Form.Label>Password: </Form.Label>
    <Form.Control id="Password" as="input" name="Password"  onChange={formik.handleChange}
            value={formik.values.Password}  required type="password" placeholder="Password"  />
    ...
    <Card border="light" className="text-center p-0 mb-4">
      ...
      <Card.Body className="pb-5">
        ...
        <Card.Text className="text-gray mb-4">Tunis</Card.Text>

        <Button variant="primary" size="sm" className="me-2">
          <FontAwesomeIcon icon={faUserPlus} className="me-1" /> See Info
        </Button>
        <Button variant="secondary" size="sm" onClick={() => setShowDefault(true)}>Update Info</Button>
      </Card.Body>
      ))}
    </Card>
    </div></div>
    ...
    return (
      ...
      <ListGroup.Item className="px-0">
        ...
        <Row className="align-items-center">
          ...
          <Col className="col-auto">
              <FontAwesomeIcon icon={faChartLine} className="me-1" /> #1
          </Col>
        </Row></div>
      </ListGroup.Item>
    );
