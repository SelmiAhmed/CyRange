        ...
        <Row>
          <Col xs={12} lg={6} className="mb-4 mb-lg-0">
            <p className="mb-0 text-center text-xl-left">
              ...
              <Card.Link href="https://www.ansi.tn/fr" target="_blank" className="text-blue text-decoration-none fw-normal">
                ANSI
              </Card.Link>
            </p>
          </Col>
          <Col xs={12} lg={6}>
            <ul className="list-inline list-group-flush list-group-borderless text-center text-xl-right mb-0">
              <li className="list-inline-item px-0 px-sm-2">
                <Card.Link href="https://www.ansi.tn/fr/ansi/" target="_blank">
                  About
                </Card.Link>
              </li>
              <li className="list-inline-item px-0 px-sm-2">
                <Card.Link href="https://www.ansi.tn/fr/ansi/contact" target="_blank">
                  Contact
                </Card.Link>
              </li>
            </ul>
