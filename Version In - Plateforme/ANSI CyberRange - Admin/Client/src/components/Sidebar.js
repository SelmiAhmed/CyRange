...
import { faBook, faBoxOpen, faChartPie, faCog, faFileAlt, faHandHoldingUsd, faSignOutAlt, faTable, faTimes, faCalendarAlt, faMapPin, faInbox, faRocket, faUser, faPlus } from "@fortawesome/free-solid-svg-icons";
        ...
        <SimpleBar className={`collapse ${showClass} sidebar d-md-block bg-primary text-white`}>
          ...
          <Image src={Logo}  />
            ...
            <Nav className="flex-column justify-content-beetween pt-8 me-lg-2 pt-md-2">
              ...
              {/* <NavItem title="Courses" icon={faHandHoldingUsd} link={Routes.Transactions.path} />
              <NavItem title="Ressources" icon={faHandHoldingUsd} link={Routes.Transactions.path} />
              ...
              <CollapsableNavItem eventKey="Cours/" title="Cours" icon={faBook}>
                <NavItem title="Ajouter Training"  link={Routes.AjoutCours.path} />
                <NavItem title="Liste des Trainings"  link={Routes.ListeCours.path} />
              </CollapsableNavItem>
